...
function calcular() {
    ...
    g1 = document.forms[1].elements[2].value;
    a2 = document.forms[1].elements[4].value;
    b2 = document.forms[1].elements[5].value;
    g2 = document.forms[1].elements[6].value;
    a3 = document.forms[1].elements[8].value;
    b3 = document.forms[1].elements[9].value;
    g3 = document.forms[1].elements[10].value;
    r1 = document.forms[1].elements[3].value;
    r2 = document.forms[1].elements[7].value;
    r3 = document.forms[1].elements[11].value;
    ...
    ra = da/d;
    document.forms[1].elements[12].value = ra;
    rb = ((a1*r2*g3)+(r1*g2*a3)+(g1*a2*r3)-(a3*r2*g1)-(r3*g2*a1)-(g3*a2*r1))/((a1*b2*g3)+(b1*g2*a3)+(g1*a2*b3)-(a3*b2*g1)-(b3*g2*a1)-(g3*a2*b1));
    document.forms[1].elements[13].value = rb;
    rg = ((a1*b2*r3)+(b1*r2*a3)+(r1*a2*b3)-(a3*b2*r1)-(b3*r2*a1)-(r3*a2*b1))/((a1*b2*g3)+(b1*g2*a3)+(g1*a2*b3)-(a3*b2*g1)-(b3*g2*a1)-(g3*a2*b1));
    document.forms[1].elements[14].value = rg;
    document.forms[1].elements[15].value = d;
    document.forms[1].elements[16].value = da;
    document.forms[1].elements[17].value = db;
    document.forms[1].elements[18].value = dg;
}
function calcular2() {
    ...
    b2 = document.forms[0].elements[4].value;
    r1 = document.forms[0].elements[2].value;
    r2 = document.forms[0].elements[5].value;
    ...
    ra = da/d; 
    document.forms[0].elements[6].value = ra;
    rb = db/d;
    document.forms[0].elements[7].value = rb;
    document.forms[0].elements[8].value = d;
    document.forms[0].elements[9].value = da;
    document.forms[0].elements[10].value = db;
}
